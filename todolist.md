...
- [x] 배지 생성 함수 구현
  ...
  - [x] 배지 DOM 요소 생성 및 배치
- [x] 호버 시 배지 부각 기능
  - [x] 텍스트 요소에 hover 시 해당 배지 z-index 최상단 표시
  - [x] hover 해제 시 원래 z-index 복원
  - [x] hover 이벤트 리스너 등록 (cleanup 시 해제 필요)
...
- [ ] 가려진 배지 hover 시 최상단 표시 확인 (코드 구현 완료, 테스트 필요)
- [ ] hover 해제 시 z-index 복원 확인 (코드 구현 완료, 테스트 필요)
